...
define("ebookreader/plugins/mobile", ["require", "jquery"], 
	   ...
	   function initFontDialog() {
	       ...
	       /* open font options */	       
	       jQuery("#footer A.linkfont").click(function() {
		   openFontOption();
		   return false;
	       });
	   ...
	   function toggleMenu() {
	       jQuery("#footer .slidebar > DIV").toggle();
	   ...
	   function _initUI(options) {	       
	       ...
	       jQuery("#footer A.linktoc").click(function() {
	       ...
	       jQuery("#footer A.linkinfo").click(function() {
		   gui.showIntro();
		   return false;
	       });	

	       jQuery("#footer A.linkbook").click(function() {
		   toggleMenu();
		   return false;
	       });
